...
class LocAngVelStdLocal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocAngVelStdLocal(null);
  ...
  static datatype() {
    ...
    return 'localization_msg/LocAngVelStdLocal';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocAngVelStdLocal(null);
...
module.exports = LocAngVelStdLocal;
