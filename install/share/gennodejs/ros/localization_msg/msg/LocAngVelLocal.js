...
class LocAngVelLocal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocAngVelLocal(null);
  ...
  static datatype() {
    ...
    return 'localization_msg/LocAngVelLocal';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocAngVelLocal(null);
    if (msg.vx !== undefined) {
      resolved.vx = msg.vx;
    }
    else {
