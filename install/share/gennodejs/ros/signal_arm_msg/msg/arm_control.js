...
class arm_control {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.p_des, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.p_des = _arrayDeserializer.float64(buffer, bufferOffset, null)
  ...
  static datatype() {
    ...
    return 'signal_arm_msg/arm_control';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '1078faf5ed48378946248674a8084d99';
  }
