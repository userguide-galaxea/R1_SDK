...
(cl:defmethod cl:initialize-instance :after ((m <FunctionFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FunctionFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hdas_msg-srv:<FunctionFrame-request> is deprecated: use hdas_msg-srv:FunctionFrame-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <FunctionFrame-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hdas_msg-srv:command-val is deprecated.  Use hdas_msg-srv:command instead.")
  (command m))
...
(cl:defmethod cl:initialize-instance :after ((m <FunctionFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FunctionFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hdas_msg-srv:<FunctionFrame-response> is deprecated: use hdas_msg-srv:FunctionFrame-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <FunctionFrame-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hdas_msg-srv:success-val is deprecated.  Use hdas_msg-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <FunctionFrame-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hdas_msg-srv:message-val is deprecated.  Use hdas_msg-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FunctionFrame-response>)))
  ...
  "hdas_msg/FunctionFrameResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FunctionFrame-response)))
  "Returns string type for a service object of type 'FunctionFrame-response"
  "hdas_msg/FunctionFrameResponse")
