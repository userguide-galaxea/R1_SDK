...
(cl:defclass <status_stamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type signal_arm_msg-msg:status
    :initform (cl:make-instance 'signal_arm_msg-msg:status)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <status_stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'status_stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name signal_arm_msg-msg:<status_stamped> is deprecated: use signal_arm_msg-msg:status_stamped instead.")))
