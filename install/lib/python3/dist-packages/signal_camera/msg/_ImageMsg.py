...
"""autogenerated by genpy from signal_camera/ImageMsg.msg. Do not edit."""
import codecs
import sys
...
class ImageMsg(genpy.Message):
  _md5sum = "9094ee16737ae46f3b9ab1bbbc8bf491"
  _type = "signal_camera/ImageMsg"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Ebot publish image msg format.
...
string frame_id
"""
  __slots__ = ['header','timebase','point_num','lidar_id','rsvd']
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,timebase,point_num,lidar_id,rsvd
    ...
    """
    if args or kwds:
      super(ImageMsg, self).__init__(*args, **kwds)
